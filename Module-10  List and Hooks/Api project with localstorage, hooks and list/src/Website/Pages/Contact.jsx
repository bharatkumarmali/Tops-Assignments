...
function Contact() {
    return (
        <div>
            ...
            {/* Page Header End */}
            {/* Contact Start */}
            <div className="container m-auto bg-light overflow-hidden px-lg-0" style={{ margin: '6rem 0' }}>
                    ...
                    <div className="row g-0 mx-lg-0">
                        <div className="col-lg-6 contact-text py-5 wow fadeIn" data-wow-delay="0.5s">
                            <div className="p-lg-5 ps-lg-0">
                                ...
                                <p className="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax &amp; PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a>Download Now</a>.</p>
                                <form>
