...
function Ulogin() {
    ...
    const submitHandle = async (e) => {
        ...
        try {
            ...
            // session create 
            localStorage.setItem('uloginid', use.id)
            localStorage.setItem('uname', use.name)
        ...
        <div>
            ...
            <div className="container-fluid page-header py-5 mb-5">
                <div className="container py-5">
                    <h1 className="display-3 text-white mb-3 animated slideInDown">User Login</h1>
                        ...
                        <MDBRow>
                            ...
                            <MDBCol col='4' md='6'>
                                ...
                                <div className='text-center text-md-start mt-4 pt-2'>
                                    <MDBBtn className="mb-0 px-5" size='lg' onClick={submitHandle}>Login</MDBBtn>
